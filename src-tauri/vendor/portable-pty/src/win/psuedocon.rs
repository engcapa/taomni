    ...
    pub fn new(size: COORD, input: FileDescriptor, output: FileDescriptor) -> Result<Self, Error> {
        ...
        let result = unsafe {
            (CONPTY.CreatePseudoConsole)(
                ...
                // Do not request INHERIT_CURSOR here: Taomni is a GUI/Tauri
                // process without a usable parent console, and that flag can
                // block ConPTY creation for local PowerShell sessions.
