...
#[derive(Copy, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub struct TCompareOp(pub i32);

impl TCompareOp {
  pub const LESS: TCompareOp = TCompareOp(0);
  pub const LESS_OR_EQUAL: TCompareOp = TCompareOp(1);
  pub const EQUAL: TCompareOp = TCompareOp(2);
  pub const NOT_EQUAL: TCompareOp = TCompareOp(3);
  pub const GREATER_OR_EQUAL: TCompareOp = TCompareOp(4);
  pub const GREATER: TCompareOp = TCompareOp(5);
  pub const NO_OP: TCompareOp = TCompareOp(6);
  pub const ENUM_VALUES: &'static [Self] = &[
    Self::LESS,
    Self::LESS_OR_EQUAL,
    Self::EQUAL,
...
impl TSerializable for TCompareOp {
  #[allow(clippy::trivially_copy_pass_by_ref)]
  fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    o_prot.write_i32(self.0)
  }
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TCompareOp> {
    let enum_value = i_prot.read_i32()?;
    Ok(TCompareOp::from(enum_value))
  }
}

impl From<i32> for TCompareOp {
  fn from(i: i32) -> Self {
    match i {
      0 => TCompareOp::LESS,
      1 => TCompareOp::LESS_OR_EQUAL,
      2 => TCompareOp::EQUAL,
      3 => TCompareOp::NOT_EQUAL,
      4 => TCompareOp::GREATER_OR_EQUAL,
      5 => TCompareOp::GREATER,
      6 => TCompareOp::NO_OP,
      _ => TCompareOp(i)
    }
  }
...
impl From<TCompareOp> for i32 {
  fn from(e: TCompareOp) -> i32 {
    e.0
  }
}
...
pub trait TTHBaseServiceSyncClient {
  ...
  fn check_and_mutate(&mut self, table: Vec<u8>, row: Vec<u8>, family: Vec<u8>, qualifier: Vec<u8>, compare_op: TCompareOp, value: Vec<u8>, row_mutations: TRowMutations) -> thrift::Result<bool>;
    ...
    (
      {
        ...
        let call_args = THBaseServiceCheckAndMutateArgs { table, row, family, qualifier, compare_op, value, row_mutations };
        self.o_prot_mut().write_message_begin(&message_ident)?;
        call_args.write_to_out_protocol(self.o_prot_mut())?;
        self.o_prot_mut().write_message_end()?;
        self.o_prot_mut().flush()
...
pub trait THBaseServiceSyncHandler {
  ...
  /// 
  /// @return true if the row was mutated, false otherwise
  fn handle_check_and_mutate(&self, table: Vec<u8>, row: Vec<u8>, family: Vec<u8>, qualifier: Vec<u8>, compare_op: TCompareOp, value: Vec<u8>, row_mutations: TRowMutations) -> thrift::Result<bool>;
  /// Get a table descriptor.
  /// @return the TableDescriptor of the giving tablename
  /// 
...
impl TTHBaseServiceProcessFunctions {
  ...
  pub fn process_check_and_mutate<H: THBaseServiceSyncHandler>(handler: &H, incoming_sequence_number: i32, i_prot: &mut dyn TInputProtocol, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    ...
    match handler.handle_check_and_mutate(args.table, args.row, args.family, args.qualifier, args.compare_op, args.value, args.row_mutations) {
      Ok(handler_return) => {
...
impl THBaseServiceCheckAndMutateArgs {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<THBaseServiceCheckAndMutateArgs> {
    ...
    let mut f_3: Option<Vec<u8>> = None;
    let mut f_4: Option<Vec<u8>> = None;
    let mut f_5: Option<TCompareOp> = None;
    let mut f_6: Option<Vec<u8>> = None;
    ...
    loop {
      ...
      match field_id {
        ...
        5 => {
          let val = TCompareOp::read_from_in_protocol(i_prot)?;
          f_5 = Some(val);
        },
        6 => {
          let val = i_prot.read_bytes()?;
    ...
    verify_required_field_exists("THBaseServiceCheckAndMutateArgs.compare_op", &f_5)?;
    ...
    let ret = THBaseServiceCheckAndMutateArgs {
      ...
      family: f_3.expect("auto-generated code should have checked for presence of required fields"),
      qualifier: f_4.expect("auto-generated code should have checked for presence of required fields"),
      compare_op: f_5.expect("auto-generated code should have checked for presence of required fields"),
  ...
  fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    ...
    o_prot.write_bytes(&self.qualifier)?;
    o_prot.write_field_end()?;
    o_prot.write_field_begin(&TFieldIdentifier::new("compareOp", TType::I32, 5))?;
    self.compare_op.write_to_out_protocol(o_prot)?;
    o_prot.write_field_end()?;
