  ...
  return (
    <div className="flex flex-col mt-3">
      <div className="flex items-center gap-2 mb-1">
        <span className="text-[11px] font-semibold" style={{ color: "var(--moba-text)" }}>
          {t("servers.output")}
        </span>
        ...
        <button
          ...
          className="flex items-center gap-1 text-[11px] px-1.5 py-0.5 rounded hover:bg-[var(--moba-hover)]"
          aria-pressed={autoScroll}
          title={t("servers.autoScroll")}
          onClick={() => setAutoScroll((v) => !v)}
          style={{ color: autoScroll ? "var(--moba-accent)" : "var(--moba-text-muted)" }}
        >
      ...
      <div
        ...
        style={{
          height: 120,
          background: "var(--moba-term-bg)",
          color: "var(--moba-term-text)",
          fontFamily:
      ...
      >
        {logLines.length === 0 ? (
          <div style={{ color: "var(--moba-text-muted)", opacity: 0.7 }}>—</div>
        ) : (
