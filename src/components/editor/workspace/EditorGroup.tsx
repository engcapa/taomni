        ...
        <div className="h-full min-h-0 relative">
          {activeFile ? (
            <div className="absolute inset-0 flex flex-col">
              {breadcrumbs}
              <div className="min-h-7 shrink-0 flex items-center gap-2 px-3 border-b border-[var(--taomni-code-border)] bg-[var(--taomni-code-gutter-bg)] text-[length:var(--taomni-code-editor-ui-small-font-size)] text-[var(--taomni-code-text)]">
                <span className="truncate text-[var(--taomni-code-muted)]">{activeFile.subtitle}</span>
