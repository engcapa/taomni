...
<!-- ide-task {"id":"ED-PARITY-002","status":"ready","priority":"P0","size":"M","depends_on":[],"spec":"docs-feature/code-workspace-idea-parity/save-race-baseline-plan.md#ed-parity-002","acceptance":["ED-PARITY-002-A1","ED-PARITY-002-A2","ED-PARITY-002-A3"],"required_evidence":["document","code-audit","native","unit","typecheck"],"audit":{"date":"2026-09-15","head":"c7bbdee56cef0478d35aaa8d17124e30a299768a","finding":"根据 P0 及后续文档补录待规划目标，未重新核验生产行为。P0 的 REQ-11 未采 native 保存；后续卡有局部 save/undo 证据，须先检查能否覆盖本序列，不能将缺证据直接写成保存 bug。"},"prior_completion":{"kind":"new-task","completed":false},"p0":{"audit_id":"AUDIT-20260913-01","requirements":["REQ-11"],"scenarios":["CW-EDIT-003"],"planning_required":false},"note":"2026-09-16 P1 完成；审查 HEAD 149be0e882ef638cae6b1d08984eaa21275966c6，外部推进后的交接 HEAD 2901d541cbbf3a610b1c7873f73391b1529884bb（审查源 hash 未变）。独立 DEC/AC/V、Windows IDEA 保存/冲突/Esc/恢复参照及 P2 责任已明确；RISK-01 watcher await 后旧快照合并待复现，W1/W2 原生时点采集由 P2 建立；旧 native_click 用例不兼容 Windows，不继承历史豁免或 PASS。所有产品验证未执行；无开发领取。"} -->
